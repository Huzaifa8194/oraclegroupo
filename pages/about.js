          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="about-content-box content-box-gap mb-50">
                ...
                <p style={{ fontSize: '2em', textAlign: "justify"}}>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="team-member_one text-center mb-40 wow fadeInUp">
                ...
                <div className="member-info">
                  <h3 className="title">
                    <Link href="/farmers">
                      <a style={{ color: "white" }}>Lorne Harari</a>
                    </Link>
                  </h3>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="team-member_one text-center mb-40 wow fadeInDown">
                ...
                <div className="member-info">
                  <h3 className="title">
                    <Link href="/farmers">
                      <a style={{ color: "white" }}>Saul Stricker </a>
                    </Link>
                  </h3>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="team-member_one text-center mb-40 wow fadeInUp">
                ...
                <div className="member-info">
                  <h3 className="title">
                    <Link href="/farmers">
                      <a style={{ color: "white" }}>Christopher Bregman</a>
                    </Link>
                  </h3>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="team-member_one text-center mb-40 wow fadeInDown">
                ...
                <div className="member-info">
                  <h3 className="title">
                    <Link href="/farmers">
                      <a style={{ color: "white" }}>Paul Orsenigo</a>
                    </Link>
                  </h3>
